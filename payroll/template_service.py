...
def send_template_email(employee_id, email_body, subject, template_name="", design_id="corporate"):
    ...
    # Build styled HTML
    html_content = build_html_email(email_body, design_id, emp_name, template_name)
...
def build_html_email(body_text, design_id, recipient_name, template_name):
    """
    ...
    return renderer(body_html, recipient_name, template_name, today)
...
def _design_corporate(body, name, title, today):
...
<table width="640" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
  ...
  <tr><td style="padding:28px 32px 20px 32px;border-bottom:1px solid #e2e8f0;">
    ...
    <tr>
      <td>
        <div style="display:inline-block;width:32px;height:32px;background:linear-gradient(135deg,#0a66c2,#818cf8);border-radius:6px;text-align:center;line-height:32px;color:#fff;font-weight:800;font-size:14px;margin-right:10px;vertical-align:middle;">B</div>
        <span style="font-size:15px;font-weight:800;color:#1e293b;text-transform:uppercase;letter-spacing:0.02em;vertical-align:middle;">B2Linq Technologies Inc</span>
    ...
    <tr>
      <td>
        <div style="display:inline-block;background:#ecfdf5;border:1px solid #a7f3d0;border-radius:20px;padding:4px 12px;">
          ...
          <span style="font-size:8px;color:#065f46;font-weight:700;text-transform:uppercase;letter-spacing:0.15em;vertical-align:middle;">B2Linq Verified</span>
        </div>
      </td>
...
def _design_executive(body, name, title, today):
...
<table width="640" cellpadding="0" cellspacing="0" style="background-color:#1a1a2e;border-radius:8px;overflow:hidden;border:1px solid rgba(245,158,11,0.15);box-shadow:0 8px 32px rgba(0,0,0,0.3);">
  ...
  <tr><td style="padding:28px 32px 20px 32px;border-bottom:1px solid rgba(245,158,11,0.15);">
    ...
    <tr>
      <td>
        <div style="display:inline-block;width:36px;height:36px;background:linear-gradient(135deg,#d97706,#fbbf24);border-radius:50%;text-align:center;line-height:36px;color:#1a1a2e;font-weight:800;font-size:15px;margin-right:12px;vertical-align:middle;">B</div>
        <span style="font-size:14px;font-weight:800;color:#fef3c7;text-transform:uppercase;letter-spacing:0.15em;vertical-align:middle;">B2Linq Technologies Inc</span>
    ...
    <tr>
      <td style="text-align:center;vertical-align:middle;">
        <div style="display:inline-block;width:48px;height:48px;border:2px solid rgba(245,158,11,0.3);border-radius:50%;text-align:center;line-height:44px;">
          <span style="color:#fbbf24;font-weight:800;font-size:11px;letter-spacing:0.15em;">B2L</span>
        </div>
...
def _design_gradient(body, name, title, today):
...
<table width="640" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
  ...
  <tr><td style="background:linear-gradient(135deg,#7c3aed,#d946ef,#ec4899);padding:28px 32px;">
    ...
    <tr>
      <td>
        <div style="display:inline-block;width:36px;height:36px;background:rgba(255,255,255,0.2);border-radius:8px;text-align:center;line-height:36px;color:#fff;font-weight:800;font-size:15px;margin-right:12px;vertical-align:middle;border:1px solid rgba(255,255,255,0.1);">B</div>
        <span style="font-size:16px;font-weight:800;color:#ffffff;text-transform:uppercase;letter-spacing:0.02em;vertical-align:middle;">B2Linq Technologies Inc</span>
    ...
    <tr>
      <td>
        ...
        <div style="display:inline-block;vertical-align:middle;">
          ...
          <div style="font-size:8px;color:#94a3b8;">Digitally processed by B2Linq HR Suite</div>
        </div>
      </td>
      <td style="text-align:right;">
...
def _design_minimal(body, name, title, today):
...
<table width="640" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:4px;overflow:hidden;border:1px solid #e2e8f0;">
  ...
  <tr><td style="padding:40px 40px 24px 40px;border-bottom:1px solid #e2e8f0;">
    ...
    <tr>
      <td>
        <div style="font-size:20px;font-weight:300;color:#1e293b;text-transform:uppercase;letter-spacing:0.25em;">B2Linq Technologies Inc</div>
  ...
  <tr><td style="padding:28px 40px 36px 40px;border-top:1px solid #e2e8f0;">
    ...
    <div style="text-align:center;margin-top:28px;opacity:0.3;">
      ...
      <span style="font-size:7px;color:#94a3b8;letter-spacing:0.3em;text-transform:uppercase;font-family:Arial,sans-serif;margin:0 8px;vertical-align:middle;">B2Linq</span>
      <span style="display:inline-block;width:24px;height:1px;background:#94a3b8;vertical-align:middle;"></span>
    </div>
  </td></tr>
</table>
