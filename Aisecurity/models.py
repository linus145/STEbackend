...
class ProctoringSession(models.Model):
    ...
    session = models.OneToOneField(InterviewSession, on_delete=models.CASCADE, related_name='proctoring')
...
class ViolationLog(models.Model):
    ...
    metadata = models.JSONField(default=dict, blank=True) # To store e.g. confidence score, browser info
    ...
    def __str__(self):
        return f"{self.violation_type} - {self.proctoring_session.session.candidate.email}"
