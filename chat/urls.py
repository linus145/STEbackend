...
from .views import ChatRoomListView, Initialize1to1RoomView, DirectMessageRoomView, MessageHistoryView, DeleteMessageView
...
urlpatterns = [
    ...
    path('rooms/direct/', DirectMessageRoomView.as_view(), name='direct-message-room'),
